...
##### Read count report
`r paste("1. ", "Total number of reads mapped to payload pasmid is: ", stat1_df$V2, sep=" ")`
`r paste("2. ", "Reads in step 1 are mapped to Sus scrofa v11.1. Total number of reads after excluding homologous regions between payload pasmid and Ssc11.1 is : ", stat2_df$V2, sep=" ")`
